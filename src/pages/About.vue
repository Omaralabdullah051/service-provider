<template>
     <div>
            <div>
                <img className='mx-auto w-40 md:w-60 xl:w-80 border-x-4 border-slate-700 bg-slate-300' src="../assets/myself.png" alt="" data-aos="zoom-out-up"
            data-aos-easing="linear"
            data-aos-duration="1000"/>
            </div>
            <div className='bg-slate-800 mx-2 md:mx-10 lg:mx-30 xl:mx-60 text-white font-semibold p-8 text-justify' data-aos="fade-up-right"
            data-aos-easing="linear"
            data-aos-duration="1000">
