<template>
     <div className='p-10 font-semibold text-justify space-y-8' data-aos="zoom-out-up"
            ...
            <p className='text-xs md:text-base '>An improperly exposed or blurry picture is unusable, but one not precisely framed may still be saved. For this reason, you should always focus on and properly expose for the subject before adjusting the frame.This is something that happens more often when you have extreme lights and darks in the same scene.</p>
            <p className='text-xs md:text-base '>When taking portrait photographs at any aperture, make sure you nail the focus on the eyes. As long as the eyes are in focus, both you and your subject are more likely to consider the picture to be properly shot.</p>
            <p className='text-xs md:text-base '>The more mistakes you make, the faster you'll learn and improve your photography skills. All professional photographers once started without an understanding of anything on a camera. The real value is in turning mistakes into lessons that build your skills. So try a technique or style you haven't done before and expect to make many mistakes along the way.</p>
            <p className='text-xs md:text-base '>Getting proper exposure in photography consists of balancing three things: shutter speed, aperture, and ISO settings. You can start off by shooting in automatic or priority mode, but to get full control and shoot with manual camera controls you'll have to understand the relationship between these three things that each directly affect the exposure and quality of your image.</p>
        </div>
</template>
